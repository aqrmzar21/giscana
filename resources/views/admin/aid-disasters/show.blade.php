...
<div class="bg-white shadow rounded-lg">
    <div class="px-4 py-5 sm:p-6">
        ...
        <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
            ...
            <div>
                <dt class="text-sm font-medium text-gray-500">Total KK</dt>
                <dd class="mt-1 text-sm text-gray-900">{{ number_format($aidDisaster->total_recipients ?? 0) }} orang</dd>
            </div>
            <div>
                <dt class="text-sm font-medium text-gray-500">Bantuan Tersalur</dt>
                <dd class="mt-1 text-sm text-gray-900">{{ number_format($aidDisaster->distributed_aid ?? 0) }} orang</dd>
            </div>
            <div>
                <dt class="text-sm font-medium text-gray-500">Sisa</dt>
