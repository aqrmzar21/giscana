...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Form Tambah Rute Evakuasi</h3>
    </div>
    <form action="{{ route('admin.evacuation-routes.store') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control @error('length_km') is-invalid @enderror" id="length_km" name="length_km" value="{{ old('length_km') }}">
                        @error('length_km')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('capacity_per_hour') is-invalid @enderror" id="capacity_per_hour" name="capacity_per_hour" value="{{ old('capacity_per_hour') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('line_coordinates') is-invalid @enderror" id="line_coordinates" name="line_coordinates" rows="5" required>{{ old('line_coordinates') }}</textarea>
