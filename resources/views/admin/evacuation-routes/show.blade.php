    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                <dt class="text-sm font-medium text-gray-500">Koordinat Garis</dt>
                <dd class="mt-1 text-sm text-gray-900">
                    <pre class="bg-gray-50 p-4 rounded-md text-xs overflow-x-auto">{{ json_encode($evacuationRoute->line_coordinates, JSON_PRETTY_PRINT) }}</pre>
                </dd>
            </div>
            <div>
                <dt class="text-sm font-medium text-gray-500">Dibuat</dt>
                <dd class="mt-1 text-sm text-gray-900">{{ $evacuationRoute->created_at->format('d/m/Y H:i:s') }}</dd>
            </div>
            <div>
                <dt class="text-sm font-medium text-gray-500">Diperbarui</dt>
                <dd class="mt-1 text-sm text-gray-900">{{ $evacuationRoute->updated_at->format('d/m/Y H:i:s') }}</dd>
            </div>
        </dl>
