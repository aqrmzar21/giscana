...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Form Tambah Zona Bencana</h3>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('risk_level') is-invalid @enderror" id="risk_level" name="risk_level" required>
                    ...
                    <option value="very_high" {{ old('risk_level') === 'very_high' ? 'selected' : '' }}>Sangat Tinggi</option>
                </select>
                @error('risk_level')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control @error('area_hectares') is-invalid @enderror" id="area_hectares" name="area_hectares" value="{{ old('area_hectares') }}">
                        @error('area_hectares')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('affected_population') is-invalid @enderror" id="affected_population" name="affected_population" value="{{ old('affected_population') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('polygon_coordinates') is-invalid @enderror" id="polygon_coordinates" name="polygon_coordinates" rows="5" required>{{ old('polygon_coordinates') }}</textarea>
