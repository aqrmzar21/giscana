    ...
    <div class="px-4 py-5 sm:p-6">
        <div class="sm:flex sm:items-center mb-6">
            <div class="sm:flex-auto">
                <h3 class="text-lg font-medium leading-6 text-gray-900">Detail Informasi Penerima Bantuan</h3>
                <p class="mt-1 text-sm text-gray-500">Rincian lengkap data penerima dan bantuan yang telah disalurkan.</p>
            </div>
