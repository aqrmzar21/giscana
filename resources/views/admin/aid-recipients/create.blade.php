    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        <form action="{{ route('admin.aid-recipients.store') }}" method="POST">
            ...
            <div class="space-y-6 sm:space-y-5">
                ...
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    <label for="zone" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">Kecamatan <span class="text-red-500">*</span></label>
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        @php
                        ...
                        <select id="zone" name="district_id" required class="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md">
